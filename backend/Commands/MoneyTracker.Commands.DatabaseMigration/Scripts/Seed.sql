...
INSERT INTO register (payee, amount, datePaid, category_id, account_id) VALUES
	...
	('Supermarket', 25, '2024-08-01', 4, 2),
	('Supermarket', 23, '2024-08-08', 4, 2),
	('Supermarket', 27, '2024-08-15', 4, 2),
	('Hobby item', 150, '2024-08-09', 5, 1),
	('Company A', 1500, '2024-08-28', 1, 3),
	('Vet', 75, '2024-08-29', 6, 3),
	('Football kit', 100, '2024-08-30', 5, 3);

INSERT INTO bill (payee, amount, nextduedate, frequency, category_id, monthday, account_id) VALUES
    (12, 23, '2024-09-03', 'Weekly', 4, 3, 1),
    (13, 100, '2024-08-30', 'Monthly', 1, 30, 2),
    (13, 100, '2024-08-30', 'Monthly', 1, 30, 3);
