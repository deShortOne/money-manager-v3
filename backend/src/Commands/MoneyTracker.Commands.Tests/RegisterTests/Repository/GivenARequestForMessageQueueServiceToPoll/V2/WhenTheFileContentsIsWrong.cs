...
public class WhenTheFileContentsIsWrong : MessageQueueServiceHelper
{
    ...
    public override async Task InitializeAsync()
    {
        ...
        var fileContentsFromFileUploadRepository = new VersionNumberObject
        {
            VersionNumber = 2,
        };
    ...
    public void ThenTheFailedProcessedFileIdsAreMappedCorrectly()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.Equal("ERROR: object does not contain data: {\"VersionNumber\":2}", result.Error!.Description);
        });
    }
