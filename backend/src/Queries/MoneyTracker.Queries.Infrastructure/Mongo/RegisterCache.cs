...
public class RegisterCache : IRegisterCache
{
    ...
    public Task<List<ReceiptIdAndStateEntity>> GetReceiptStatesForUser(AuthenticatedUser user, CancellationToken cancellationToken) => throw new NotImplementedException("Receipt id and state is never cached");
