...
namespace InterceptDoubleNegativeResult;
...
public class InterceptDoubleNegativeResultAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly LocalizableString MessageFormat =
        new LocalizableResourceString(nameof(Resources.MT0001MessageFormat), Resources.ResourceManager,
            typeof(Resources));

    private static readonly LocalizableString Description =
        new LocalizableResourceString(nameof(Resources.MT0001Description), Resources.ResourceManager,
            typeof(Resources));
